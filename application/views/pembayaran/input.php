      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
              <div class="box-body">
                <form action="<?= site_url('/pembayaran/tambah_aksi'); ?>" method="post">
                  <div class="form-group row">
                    ...
                    <?php foreach($kode as $b){ ?>
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" id="kd_resep" name="kd_resep" value="<?php echo  $b->kd_resep ?>" readonly> 
                      </div>
                    <?php } ?>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" id="id_periksa" name="pengobatan" value="<?php echo  $b->pengobatan ?>" readonly>
                      </div>
                    </div> 
                    <?php } ?>
                    ...
                    <table id="example2" class="table table-bordered table-hover ">
                      ...
                      <tfoot>
                        ...
                        <tr>  
                          ...
                          <td>
                            <center>
                              <a class="btn btn-warning" href="<?= site_url().'/pembayaran/hapus_detail_bayar/'.$kodebayar;?>">Batal</a>
                            </center>
                          </td>
...
<script type="text/javascript">
  $(document).ready(function(){
    $('#id_tarif').change(function(){
      ...
      $.ajax({
        type : 'POST',
        url : '<?= site_url('/pembayaran/cek_tarif') ?>',
        Cache : false,
        dataType: "json",
        data : 'id_tarif='+id,
...
<script type="text/javascript">
  $(document).ready(function(){
    $('#kd_resep').change(function(){
      ...
      $.ajax({
        type : 'POST',
        url : '<?= site_url('/pembayaran/cek_harga') ?>',
        Cache : false,
        dataType: "json",
        data : 'kd_resep='+id,
        success : function(resp){
