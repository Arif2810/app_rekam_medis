            ...
            <table  table id="example1" class="table table-bordered table-striped ">
              ...
              ?>
                <tr>
                  ...
                  <td><a class="btn btn-default" href="<?= site_url('/cetak/cetak_bayar/').$r->kd_bayar ?>"><i class="fa fa-print"></i>Cetak</a>
                    <a class="btn btn-danger" href="<?= site_url('/pembayaran/hapus/').$r->kd_bayar ?>"><i class="fa fa-trash"></i>Hapus</a>
                  </td>
                </tr>
              <?php } ?>
