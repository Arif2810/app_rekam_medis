			...
			<div class="col-xs-12">
				<div class="box">
					...
					<?php foreach($dokter as $dokter){ ?>
						<form action="<?= site_url('/data_dokter/update');?>" method="post">
							...
							<div class="form-group row">
								...
								<div class="col-sm-4">
									<div class="custom-control custom-radio custom-control-inline">
										<input type="radio" id="1" name="aktif" class="minimal" value="1" <?php if($dokter->aktif == '1'){echo 'checked';} ?>/>
										<label class="custom-control-label" for="1">Aktif</label>
									</div>
									<div class="custom-control custom-radio custom-control-inline">
										<input type="radio" id="2" name="aktif" class="minimal" value="0" <?php if($dokter->aktif == '0'){echo 'checked';} ?>/>
							...
							<div class="form-group row">
								<div class="col-sm-10">
									...
									<a href="<?= site_url('data_dokter/index'); ?>" class="btn btn-success">Kembali</a>
								</div>
							</div>
						<?php } ?>
					</form>
