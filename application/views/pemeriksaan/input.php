              ...
              <!-- form start -->
              <div class="box-body">
                <form action="<?= site_url('/pemeriksaan/tambah_aksi'); ?>" method="post">
                ...
                <table id="example1" class="table table-bordered table-striped ">
                  ...
                  ?> 
                    <tr>
                      ...
                      <td><?= $r->tindakan ?></td>
                      <td>
                        <a href="<?= site_url('/pemeriksaan/hapus/'.$r->id_periksa) ?>" class="btn btn-danger float-right" onclick="return confirm('yakin dok, mau dihapus?');">Hapus</a>  
                      </td>
                    </tr> 
                  <?php } ?>
                  </tbody>                  
