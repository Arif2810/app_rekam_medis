            ...
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <div class="box box-primary">
                  <div class="box-body">
                    <form action="<?= site_url('/resep_obat/tambah_aksi'); ?>" method="post">
                      ...
                      <table id="example2" class="table table-bordered table-striped ">
                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                              <a href="<?= site_url('/resep_obat/hapus/'.$r->id_detail) ?>" class="btn btn-danger btn-xs float-right">Hapus</a>  
                            </td>
                          </tr>
                        <?php } ?>
                        </tbody>
                        <tfoot>
                          <tr>
                            ...
                            <td>
                              <center>
                                <div class="box-footer">
                                  <a class="btn btn-warning" href="<?= site_url().'/cetak/cetak_resep/'.$koderesep ?>">Cetak</a>
                                  <a class="btn btn-primary" href="<?= site_url().'/resep_obat/hapus_detail_resep/'.$koderesep ?>">Batal</a>
                                </div>
                              </center>
                            </td>
...
<script type="text/javascript">
  $(document).ready(function(){
    $('#id_obat').change(function(){
      ...
      $.ajax({
        type : 'POST',
        url : '<?= site_url('/resep_obat/cek_obat') ?>',
        Cache : false,
        dataType: "json",
        data : 'id_obat='+id,
